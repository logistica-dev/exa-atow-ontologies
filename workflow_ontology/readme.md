...
Conceptual structure of the Exa-AToW Workflow Ontology illustrating its core classes and their alignment to corresponding concepts in the **PROV-O** and **WF4EVER** ontologies. This approach integrates Exa-AToW with community standards. The ontology's WorkflowProperty section, which defines key descriptive standards, is specifically based on the research outlined in Suter et al. 2026.
